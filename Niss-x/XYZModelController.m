...
@interface XYZModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation XYZModelController
...
{   
    ...
    XYZDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"XYZDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(XYZDataViewController *)viewController];
